...
// Auto-discovers any `appEntry.ts` file under src/windows (e.g. src/windows/about_me/appEntry.ts).
// Adding a new app to the site requires no edits here - just drop an appEntry.ts in the app's folder.
const appModules = import.meta.glob("../../windows/*/appEntry.ts", { eager: true });
