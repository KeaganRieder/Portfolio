...
import type { ShortcutDefinition } from "@/system/shortcut/types";
import { openLinkInNewTab } from "@/system/shortcut/clickActions";

import { ApplicationShortcut } from "@/system/shortcut/applicationShortcut";
import { buildRegistryEntries } from "./buildRegistryEntries";
import type { RegistryEntry, RegistryEntryKind } from "./types";
